...
export default function ManagerDashboardPage() {
  ...
  useEffect(() => {
    ...
    // Load stats
    const spaces = JSON.parse(localStorage.getItem("condoconnect_spaces") || "[]")
  ...
  return (
    <div className="min-h-screen bg-muted">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Painel do Síndico</h1>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <Card className="p-6">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-1">{stats.totalSpaces}</h3>
          ...
          <Card className="p-6">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-1">{stats.pendingReservations}</h3>
          ...
          <Card className="p-6">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-1">{stats.totalAnnouncements}</h3>
